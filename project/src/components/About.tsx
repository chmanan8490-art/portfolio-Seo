      ...
      <div ref={ref} className={`container-px grid lg:grid-cols-2 gap-12 items-center reveal ${visible ? 'is-visible' : ''}`}>
        <div className="relative">
          ...
          <div className="relative card p-8">
            ...
            <h3 className="font-heading font-bold text-2xl text-slate-900 dark:text-white mb-2 text-center">Suffyan</h3>
            ...
            <div className="mt-6 grid grid-cols-3 gap-3 text-center">
              <div className="rounded-xl bg-slate-50 border border-slate-200 dark:bg-slate-950/60 dark:border-slate-800 p-3">
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {aboutSpecialties.map((s) => (
              <div key={s} className="flex items-center gap-3 group">
                ...
                <span className="text-slate-700 dark:text-slate-200 font-medium">{s}</span>
              </div>
            ))}
          </div>
        </div>
